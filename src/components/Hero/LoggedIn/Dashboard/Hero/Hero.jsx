      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">
            Here are the tables you have most recently made changes too.
          </p>
        ...
        <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
          <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
            ...
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                Articles which might help me for ideas when I'm writing my own
                blog while in India.
              </p>
          ...
          <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
            ...
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                Been looking for some new gear. Need trainers, socks for the
                blisters and a few other things. These are mostly review videos.
              </p>
              <a className="mt-3 text-green-500 inline-flex items-center">
                Edit
                <svg
          ...
          <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
            ...
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                Lots of gear I might invest in some day now I have a Canon EOS
                5D MKIII.
              </p>
              <a className="mt-3 text-green-500 inline-flex items-center">
                Edit
